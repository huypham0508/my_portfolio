...
function DescComponent() {
  return (
    <div className="">
      <h1 className="text-5xl font-bold mt-32 mb-2">Software Developer</h1>
      ...
      <div className="flex items-center gap-5 mb-3">
        <span>
          <Link href="https://github.com/huypham0508">
            <Image className="w-8" alt="github icon" src={githubIcon} />
          </Link>
        </span>
        <span>
      ...
      <div>
        ...
        <div className="flex mt-3 items-center justify-start gap-3">
          <Image
            height={40}
            width={40}
            alt="html icon 3D"
